...
$route['delete_alpine/(:any)'] = 'AlpineSchoolController/delete/$1';
$route['advertisements'] = 'AdvertisementController';
$route['form_ad']='FormController/form_ad';
$route['delete_ad/(:any)']='AdvertisementController/delete_ad/$1';
